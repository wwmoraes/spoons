...
function HSCaffeinate.currentAssertions() end
...
function HSCaffeinate.declareUserActivity(id) end

--- Show the Fast User Switch screen (ie a login screen without logging out first)
---
function HSCaffeinate.fastUserSwitch() end
...
function HSCaffeinate.get(sleepType) end
...
---
function HSCaffeinate.lockScreen() end

--- Request the system log out the current user
---
function HSCaffeinate.logOut() end

--- Request the system reboot
---
function HSCaffeinate.restartSystem() end
...
---
function HSCaffeinate.sessionProperties() end
...
--- @return boolean|nil @`true` if the specified type of sleep is being prevented, `false` if not. `nil` if `sleepType` was an invalid value
---
function HSCaffeinate.toggle(sleepType) end
