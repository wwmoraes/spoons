...
function URLEvent.bind(eventName, callback) end

---Gets all of the application bundle identifiers of applications able to handle a URL scheme
---@param scheme string
---@return string[]
function URLEvent.getAllHandlersForScheme(scheme) end
...
function URLEvent.openURLWithBundle(url, bundleID) end
...
function URLEvent.setDefaultHandler(scheme, bundleID) end
...
function URLEvent.setRestoreHandler(scheme, bundleID) end
