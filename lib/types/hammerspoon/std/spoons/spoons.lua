...
function HSSpoons.bindHotkeysToSpec(def, map) end
...
function HSSpoons.list(onlyLoaded) end
...
function HSSpoons.newSpoon(name, basedir, metadata, template) end
...
function HSSpoons.resourcePath(partial) end
...
function HSSpoons.scriptPath(n) end
...
function HSSpoons.use(name, arg, noerror) end
